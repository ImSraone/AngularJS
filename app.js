...
app.constant('config', {
    genders:[
    		{"entity_id":1,"entity_value":"Male"},
			{"entity_id":2,"entity_value":"Female"},
			{"entity_id":3,"entity_value":"Unknown"}
			],
    durations:[
    		{"entity_id":"day","entity_value":"Days"},
			{"entity_id":"week","entity_value":"Weeks"},
			{"entity_id":"month","entity_value":"Months"}
			],
    isactive :[
    		{"entity_id":1,"entity_value":"Yes"},
			{"entity_id":0,"entity_value":"No"}
			], 
